...
test('should initiate SerpentineMatrix', () => {
    const matrix = new SerpentineMatrix(2, 2);
    expect(matrix).toBeInstanceOf(SerpentineMatrix);
});

test('should create a correct map', () => {
    const matrix = new SerpentineMatrix(4, 4);
